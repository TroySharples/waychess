...
// tables. These are 12-bits deep for rooks, and 9-bits deep for bishops, which ends up being 64*(2**12 + 2**9)
// = 294912, which is just over 2**18. We allocate 2*19 bytes for safety - allocation errors are thrown at
// runtime if there isn't enough space anywy.
