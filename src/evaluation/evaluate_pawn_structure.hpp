...
constexpr int isolated_pawns_penalty_mg { 27 };
constexpr int isolated_pawns_penalty_eg { 54 };

constexpr int doubled_pawns_penalty_mg { 15 };
constexpr int doubled_pawns_penalty_eg { 55 };

constexpr int blocked_pawns_penalty_mg { 24 };
constexpr int blocked_pawns_penalty_eg { 34 };
...
inline int evaluate_pawn_structure_mg(const bitboard& bb)
{
    ...
    return std::popcount(get_pawn_isolated(bb.boards[b_pawn]))           * details::isolated_pawns_penalty_mg
         ...
         + std::popcount(get_black_pawn_blocked(bb.boards[b_pawn], occ)) * details::doubled_pawns_penalty_mg
         ...
         - std::popcount(get_white_pawn_blocked(bb.boards[w_pawn], occ)) * details::doubled_pawns_penalty_mg;
}
...
inline int evaluate_pawn_structure_eg(const bitboard& bb)
{
    ...
    return std::popcount(get_pawn_isolated(bb.boards[b_pawn]))           * details::isolated_pawns_penalty_eg
         ...
         + std::popcount(get_black_pawn_blocked(bb.boards[b_pawn], occ)) * details::doubled_pawns_penalty_eg
         ...
         - std::popcount(get_white_pawn_blocked(bb.boards[w_pawn], occ)) * details::doubled_pawns_penalty_eg;
}
