...
std::uint64_t get_knight_attacked_squares_from_mailbox(std::size_t mb) noexcept;
...
inline std::uint64_t get_knight_attacked_squares_from_mailbox(std::size_t mb) noexcept
{
