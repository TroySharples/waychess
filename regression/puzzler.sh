...
PUZZLER_CSV=$1
PUZZLER_DEPTH=$2
PUZZLER_HASH_BYTES=$3
PUZZLER_RESULT=$("${PUZZLER_PATH}" -f "${PUZZLER_CSV}" -d ${PUZZLER_DEPTH} -k ${PUZZLER_HASH_BYTES})
...
REGRESSION_TRACKING_PATH="${SCRIPT_DIR}"/tracking/puzzler.ndjson
