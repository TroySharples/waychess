...
int main()
{
    ...
    constexpr const char* EN_PASSENT_FEN { "rnbqkbnr/1pppp1pp/p7/4Pp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 1" };
    std::cout << "en-passent\n";
    std::cout << bitboard(EN_PASSENT_FEN);
    std::cout << '\n';

    constexpr const char* PROMOTION_FEN { "1r2k3/2P5/8/8/8/8/8/5K2 w - - 0 1" };
    std::cout << "promotion\n";
    std::cout << bitboard(PROMOTION_FEN);
    std::cout << '\n';

    std::cout << "First moves\n";
    {
        bitboard start(PROMOTION_FEN);
